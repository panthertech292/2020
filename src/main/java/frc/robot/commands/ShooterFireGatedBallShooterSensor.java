...
public class ShooterFireGatedBallShooterSensor extends CommandBase {
  /**
  ...
  public ShooterFireGatedBallShooterSensor(GateSubsystem gatesubsystem, ShooterSubsystem shootersubsystem) {
  ...
  public void initialize() {
    ...
    //m_shooterSubsystem.initCloseEnough();
  ...
  public void execute() {
    if(m_shootState == 1){
      ...
      if(m_gateSubsystem.isShooterMotorSpunUp()==true) {m_shootState = 2; System.out.println("Shooter Timed Out"); }
      //if(m_shooterSubsystem.isCloseEnough() == true){m_shootState = 2;System.out.println("Shooter Close Out");}
    }
    //
    if(m_shootState == 2) {
    ...
    if(m_shootState == 3) {
      ...
      if(m_gateSubsystem.isShooterDone()) { m_shootState = 4;System.out.println("Timer Finish");}
     // if(m_shooterSubsystem.isCloseEnough() == false){m_shootState = 4;System.out.println("Close Enough Finish");}
    ...
    //  if(m_shooterSubsystem.isCloseEnough() == true){m_shootState = 2;}
    }
