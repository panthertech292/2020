...
public class ShooterFireGatedBallSensorRange extends CommandBase {
  /**
  ...
  public ShooterFireGatedBallSensorRange(GateSubsystem gatesubsystem, ShooterSubsystem shootersubsystem, double range) {
  ...
  public void initialize() {
    ...
    m_done = false;
    m_shootCount = 0;
    m_shooterSubsystem.changeSetSpeed(m_shootSpeed);
