...
public class ShooterFireGatedTrigger extends CommandBase {
  /**
  ...
  private double m_smartSetpoint;
  //private double m_maxSetpoint;
  private double m_triggerAdjust;
  private double m_adjustedSpeed;
 
  public ShooterFireGatedTrigger(GateSubsystem gatesubsystem, ShooterSubsystem shootersubsystem) {
  ...
  public void initialize() {
    ...
    m_done = false;
    m_shootCount = 0;
    m_smartSetpoint = ShooterConstants.kShooterFull;
    //m_maxSetpoint = ShooterConstants.kShooterMax;
    m_triggerAdjust = RobotContainer.getShooterSpeedAdjust();
    m_adjustedSpeed = m_smartSetpoint + m_triggerAdjust;
    //System.out.println("ss = " + m_smartSetpoint + " ms = " + m_maxSetpoint + " ta = " + m_triggerAdjust + "as = " + m_adjustedSpeed);
    //m_shooterSubsystem.changeSetSpeed(SmartDashboard.getNumber("Set the Shooter here - Back Button", ShooterConstants.kShooterNormal));
    m_shooterSubsystem.changeSetSpeed(m_adjustedSpeed);
