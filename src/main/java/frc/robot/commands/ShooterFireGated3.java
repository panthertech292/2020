...
public class ShooterFireGated3 extends CommandBase {
  /**
  ...
  public ShooterFireGated3(GateSubsystem gatesubsystem, ShooterSubsystem shootersubsystem) {
  ...
  public void initialize() {
    ...
    m_done = false;
    m_shootCount = 0;
    m_shooterSubsystem.changeSetSpeed(ShooterConstants.kShooterAuto1);
