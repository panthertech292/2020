...
public class ShooterFireGatedSmart extends CommandBase {
  /**
  ...
  public ShooterFireGatedSmart(GateSubsystem gatesubsystem, ShooterSubsystem shootersubsystem) {
  ...
  public void execute() {
    ...
    if(m_shootState == 4) {
      ...
      if(m_gateSubsystem.isFireGatedButtonSmartStillPressed()) {
        m_shootState = 5;
      } else {
        m_done = true;
