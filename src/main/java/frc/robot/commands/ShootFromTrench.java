...
public class ShootFromTrench extends SequentialCommandGroup {
  ...
  public ShootFromTrench(GateSubsystem subsystem1, ShooterSubsystem subsystem2) {
    ...
    addCommands(
      new ShooterFireGatedBallSensorRange(m_gate, m_shooter,ShooterConstants.kShooterTrench)
